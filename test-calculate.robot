...
Get Calculation JSON
    [Arguments]    ${num1}    ${num2}
    ${resp}=     GET    http://127.0.0.1:5001/calculate/${num1}/${num2}
...
Test Calculate Numbers 4 and 2 (ฺBefore Using Keywords)
    ...
    ${resp}=     GET    http://127.0.0.1:5001/calculate/4/2
...
Test Calculate Numbers 8.4 and 4 (ฺBefore Using Keywords)
    ...
    ${resp}=     GET    http://127.0.0.1:5001/calculate/8.4/4
